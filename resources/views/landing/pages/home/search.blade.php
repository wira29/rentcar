        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-start">
                <div class="col-md-9 ftco-animate pb-5">
                    <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('landing.home') }}">Beranda <i class="ion-ios-arrow-forward"></i></a></span> <span>Pencarian <i class="ion-ios-arrow-forward"></i></span></p>
